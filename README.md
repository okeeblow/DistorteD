...
- I don't want to host my photos on a social network, so [Jekyllgram](https://github.com/benbarber/jekyll-instagram) and [jekyll-twitter-plugin](https://github.com/rob-murray/jekyll-twitter-plugin) are out.
